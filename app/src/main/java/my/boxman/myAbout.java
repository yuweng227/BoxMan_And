...
public class myAbout extends Activity {
	 ...
	 protected void onCreate(Bundle savedInstanceState) {
		...
		String s = "《推箱快手》\n\n" +
			   ...
			   "  作者：愉翁    QQ：252804303\n\n" +
			   "  策划：anian、愉翁\n\n" +
			   "  特别感谢：anian老师和杨超教授及众多热心箱友，anian老师在游戏设计的全过程中，给出了大量的指导性意见，" +
				"并进行了繁重的开发期测试，尤其在“割点”寻径及“穿越”寻径等算法方面，更是得到了两位老师不遗余力的支持和帮助，" +
				"许多算法都是直接移植于杨超教授的“SokoPlayer HTML5”。" +
				"后期，植入了 JSoko（德国 Matthias Meger 大师的杰作）的死锁检测系统后，使得快手的死锁检测能力有了极大提升。" +
				"在另一方面，anian老师也为游戏提供了几乎全部的关卡集原始档案，另有部分关卡选自“http://sokoban.cn/”，" +
				...
				"Kevin Weiner, FM Software 编写的 GIF 合成代码。特此鸣谢！同时，也祝各位箱友都能很快的晋升到推箱子群中的快手之列！\n\n" +
			   "  2018年冬";
