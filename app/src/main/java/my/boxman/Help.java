...
public class Help extends Activity {
	 ...
	 protected void onCreate(Bundle savedInstanceState) {
		...
		String s = "====== 特别提醒 ======\n" +
            ...
            "====== 更新历史 ======\n" +
			"\n" +
			"BoxMan9.91：2019-1-23\n" +
			"1、优化“冻结”（原“方型”和“之字型”）死锁检测代码，创建独立类；\n" +
			"2、优化“闭锁对角”死锁检测代码；\n"  +
			"3、优化关卡浏览功能，同时，此处增设“添加关卡”、“导出”、改变“每行图标个数”等功能（麦英、爱伽斯顿）；\n"  +
			"4、优化“创编关卡”的尺寸设定和修改功能（爱伽斯顿）；\n"  +
			"5、优化关卡解析功能：解析时，忽略（直接舍弃，不再视作无效关卡记录到备注中）行数小于 3 或者列数小于 3 的关卡；对于连续的“标题”、“作者”等信息，只解析第一个；对于超尺寸关卡，视作无效关卡，并将其记录到备注中，同时，其标题强制为“无效关卡”，以便查询；在保留关卡外围造型的前提下，自动做关卡的“瘦化”处理（去除关卡外围无用的“空白”）（麦英、艾嘉斯顿、anian版主）；\n"  +
			...
			"10、推关卡时，对于导入的常规动作（不包含任何“宏”命令），自动忽略大小写执行（anian版主）；\n"  +
			...
			"14、导入导出时，使用“导入/”、“导出/”文件夹，不在使用“关卡扩展/”文件夹；对于超长无法写入DB的答案，将以文档形式写入“超长答案/”文件夹\n"  +
