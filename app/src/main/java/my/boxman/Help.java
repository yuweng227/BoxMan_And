	 ...
	 protected void onCreate(Bundle savedInstanceState) {
		...
		String s = "====== 特别提醒 ======\n" +
            ...
            "  1、“快手”中，关卡、答案采用(XSB+Lurd)标准格式，关卡（集）文档的扩展名支持“XSB、TXT、SOK、TXZ”等）；\n" +
		   	...
		   	"  9、快手编辑功能中，导入支持关卡 XSB 导入，同时支持 Lurd 导入（即：通过答案 Lurd 倒推出关卡 XSB）。另外，快手还支持关卡图的自动识别，即玩家先将关卡截图复制到“关卡图/”文件夹中，然后，通过关卡编辑功能中的“图像识别”，自动识别出关卡 XSB；\n" +
            ...
            "【单击--空地】，仓管员移动（位置可达）；\n" +
		   	"【单击--仓管员】，提示仓管员的可达位置；\n" +
		   	"【单击--箱子】，提示其可达位置（在可达提示状态，点击阶梯中的第二箱子，则提示其“阶梯”走法），再点选可达位置，则自动推箱子到位；\n" +
			"\n" +
			...
			"【长按--仓管员】，正推时，选择“导出 GIF”开始点（不选择时，默认从关卡初态开始）。逆推时，切换“禁用逆推目标点”选项开关；\n" +
			"\n" +
